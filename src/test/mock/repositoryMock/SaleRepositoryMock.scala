...
object SaleRepositoryFailureMock extends SaleRepository:
    ...
    override def saveSaleToRepository(saleEntity: SaleEntity): IO[SaleRepositoryError, Unit] = ZIO.fail(SaleRepositoryError.SaveSaleToRepositoryFailed(new Exception("error")))