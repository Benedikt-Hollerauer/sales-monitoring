...
import app.core.value.{DescriptionValue, MoneyValue, PlatformValue, TitleValue}
import app.error.entityError.SaleEntityError
import app.error.valueError.{DescriptionValueError, MoneyValueError, TitleValueError}
